{
	"translatorID":"d2bcaad8-e9d9-4e28-b42a-69bf4bb3905c",
	"translatorType":4,
	"label":"Library Catalog (Voyager-Marc2)",
	"creator":"Simon Kornblith, adapted for Marc2 by Florian Ziche",
...
function doWeb(doc, url) {
	...
	Zotero.Utilities.HTTP.doGet(newUri+'?'+postString, function(text) {
		...
		marc.setTranslator("d2c86970-04f7-4ba5-9de6-bec897930eb5");
		marc.setString(text);
